...
const Footer = () => (
  <div className="contact-container bg-gray-900 text-white py-12 px-6">
    ...
    <div className="flex flex-col md:flex-row items-center justify-center gap-10">
      {/* Profile Image */}
      <div className="hidden md:block w-40 h-50 md:w-126 md:h-86 rounded-full  shadow-lg">
        <img
      ...
      <div className="w-full max-w-md bg-gray-800 p-6 rounded-lg shadow-lg">
        ...
        ></textarea>
        <button className="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-md font-semibold transition">
          Send
        </button>
      </div>
    </div>
